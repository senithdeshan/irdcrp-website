...
use App\Http\Controllers\Admin\WeatherDistrictController;
use App\Http\Controllers\GrmComplaintController;
use App\Http\Controllers\NewsController;
use App\Http\Controllers\InstitutionalDevelopmentController;
...
Route::get('/organizational-structure', [PageController::class, 'organizationalStructure'])->name('organizational-structure');
...
Route::get('/vacancies/{vacancy}/file', [PageController::class, 'vacancyFile'])->name('vacancies.file');
...
Route::middleware(['auth', EnsureSuperAdmin::class])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::resource('project-partners', ProjectPartnerController::class)->except(['show']);
    Route::get('weather-districts', [WeatherDistrictController::class, 'index'])->name('weather-districts.index');
    Route::put('weather-districts/settings', [WeatherDistrictController::class, 'updateSettings'])->name('weather-districts.settings.update');
    Route::resource('weather-districts', WeatherDistrictController::class)->except(['index', 'show']);
    ...
    Route::get('site-modules', [SiteModuleController::class, 'index'])->name('site-modules.index');
    Route::put('site-modules', [SiteModuleController::class, 'update'])->name('site-modules.update');
