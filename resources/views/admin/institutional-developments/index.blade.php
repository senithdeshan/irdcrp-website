                    ...
                    @forelse ($items as $item)
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <a href="{{ route('admin.institutional-developments.edit', $item) }}" class="btn btn-sm btn-primary">Edit</a>
                                <form class="d-inline" method="POST" action="{{ route('admin.institutional-developments.destroy', $item) }}" onsubmit="return confirm('Remove this item?')">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center text-muted p-4">
                                No items yet. <a href="{{ route('admin.institutional-developments.create') }}">Add the first one</a>.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
