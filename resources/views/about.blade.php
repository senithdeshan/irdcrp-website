...
<section class="irdc-about-modern relative overflow-hidden py-16 sm:py-20">
    <div class="irdc-about-modern__bg irdc-parallax-bg absolute inset-0" aria-hidden="true"></div>
    ...
    <div class="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <header class="irdc-about-hero text-center">
            <h1 class="irdc-about-modern__title irdc-about-hero__item">About Us</h1>
            <p class="irdc-about-modern__subtitle irdc-about-hero__item" data-typing>Learn More About Our Mission &amp; Goals</p>
        </header>

        <div class="irdc-reveal-on-scroll mt-10 grid gap-4 sm:gap-5 md:grid-cols-2" data-reveal-stagger>
        ...
        <section class="irdc-about-panel irdc-reveal-on-scroll mt-7 sm:mt-8">
            ...
            <div class="mt-5 grid gap-4 sm:grid-cols-3" data-reveal-stagger>
